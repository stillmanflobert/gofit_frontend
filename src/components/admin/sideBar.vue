    ...
    <div class="dashboard">
        ...
        <v-dialog v-model="dialog" persistent max-width="600px" style="z-index: 1000;">
            <v-card>
                ...
                <v-card-text>
                    <v-form>
                        <v-text-field v-model="user.newPassword" label="New Password" required type="password"></v-text-field>
                        <v-text-field v-model="user.confirmPassword" label="Confirm New Password" required type="password"></v-text-field>
                    </v-form>
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
